export const TELEGRAM_LINK = 'https://t.me/proteststudio';
export const VK_LINK = 'https://vk.com/pro_test.studio';
export const TELEPHON_NUMBER = '+79933553088';
export const EMAIL = 'support@pro-test.studio';
